...
const EnhancedTableToolbar = (props: EnhancedTableToolbarProps) => {
  ...
  return (
    ...
    >
      ...
      <Button type="submit" disabled={numSelected <= 0} color="warning" variant="contained"  sx={{mr:1}}>삭제</Button> 
      <Button type="submit" color="warning" variant="contained" sx={{width:100}}>글 작성</Button> 
